...
#if defined(_SAMD21J18A_PIO_)

MorphConfigPinDefinition pin_defs[] = {
	//Pin Group, Pin Number, sercomUnit, sercomPad, sercomAltUnit, sercomAltPad
	{ 0,  0,  0, -1, -1,  1,  0, -1}, // PIN 1
	{ 0,  1,  1, -1, -1,  1,  1, -1}, // PIN 2
	{ 0,  2,  2, -1, -1, -1, -1,  0}, // PIN 3
	{ 0,  3,  3, -1, -1, -1, -1,  1}, // PIN 4
	{ 1,  4,  4, -1, -1, -1, -1, 12}, // PIN 5
	{ 1,  5,  5, -1, -1, -1, -1, 13}, // PIN 6
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 7
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 8
	{ 1,  6,  6, -1, -1, -1, -1, 14}, // PIN 9
	{ 1,  7,  7, -1, -1, -1, -1, 15}, // PIN 10
	{ 1,  8,  8, -1, -1,  4,  0,  2}, // PIN 11
	{ 1,  9,  9, -1, -1,  4,  1,  3}, // PIN 12
	{ 0,  4,  4, -1, -1,  0,  0,  4}, // PIN 13
	{ 0,  5,  5, -1, -1,  0,  1,  5}, // PIN 14
	{ 0,  6,  6, -1, -1,  0,  2,  6}, // PIN 15
	{ 0,  7,  7, -1, -1,  0,  3,  7}, // PIN 16
	{ 0,  8, -1,  0,  0,  2,  0, 16}, // PIN 17
	{ 0,  9,  9,  0,  1,  2,  1, 17}, // PIN 18
	{ 0, 10, 10,  0,  2,  2,  2, 18}, // PIN 19
	{ 0, 11, 11,  0,  3,  2,  3, 19}, // PIN 20
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 21
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 22
	{ 1, 10, 10, -1, -1,  4,  2, -1}, // PIN 23
	{ 1, 11, 11, -1, -1,  4,  3, -1}, // PIN 24
	{ 1, 12, 12,  4,  0, -1, -1, -1}, // PIN 25
	{ 1, 13, 13,  4,  1, -1, -1, -1}, // PIN 26
	{ 1, 14, 14,  4,  2, -1, -1, -1}, // PIN 27
	{ 1, 15, 15,  4,  3, -1, -1, -1}, // PIN 28
	{ 0, 12, 12,  2,  0,  4,  0, -1}, // PIN 29
	{ 0, 13, 13,  2,  1,  4,  1, -1}, // PIN 30
	{ 0, 14, 14,  2,  2,  4,  2, -1}, // PIN 31
	{ 0, 15, 15,  2,  3,  4,  3, -1}, // PIN 32
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 33
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 34
	{ 0, 16,  0,  1,  0,  3,  0, -1}, // PIN 35
	{ 0, 17,  1,  1,  1,  3,  1, -1}, // PIN 36
	{ 0, 18,  2,  1,  2,  3,  2, -1}, // PIN 37
	{ 0, 19,  3,  1,  3,  3,  3, -1}, // PIN 38
	{ 1, 16,  0,  5,  0, -1, -1, -1}, // PIN 39
	{ 1, 17,  1,  5,  1, -1, -1, -1}, // PIN 40
	{ 0, 20,  4,  5,  2,  3,  2, -1}, // PIN 41
	{ 0, 21,  5,  5,  3,  3,  3, -1}, // PIN 42
	{ 0, 22,  6,  3,  0,  5,  0, -1}, // PIN 43
	{ 0, 23,  7,  3,  1,  5,  1, -1}, // PIN 44
	{ 0, 24, 12,  3,  2,  5,  2, -1}, // PIN 45
	{ 0, 25, 13,  3,  3,  5,  3, -1}, // PIN 46
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 47
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 48
	{ 1, 22,  6, -1, -1,  5,  2, -1}, // PIN 49
	{ 1, 23,  7, -1, -1,  5,  3, -1}, // PIN 50
	{ 0, 27, 15, -1, -1, -1, -1, -1}, // PIN 51
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 52
	{ 0, 28,  8, -1, -1, -1, -1, -1}, // PIN 53
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 54
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 55
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 56
	{ 0, 30, 10, -1, -1,  1,  2, -1}, // PIN 57
	{ 0, 31, 11, -1, -1,  1,  3, -1}, // PIN 58
	{ 1, 30, 14, -1, -1,  5,  0, -1}, // PIN 59
	{ 1, 31, 15, -1, -1,  5,  1, -1}, // PIN 60
	{ 1,  0,  0, -1, -1,  5,  2,  8}, // PIN 61
	{ 1,  1,  1, -1, -1,  5,  3,  9}, // PIN 62
	{ 1,  2,  2, -1, -1,  5,  0, 10}, // PIN 63
	{ 1,  3,  3, -1, -1,  5,  1, 11}, // PIN 64
...
#elif defined(_SAMD21G18A_PIO_) || defined(_SAMD21G18AU_PIO_)

MorphConfigPinDefinition pin_defs[] = {
	//Pin Group, Pin Number, ExtIntUnit, sercomUnit, sercomPad, sercomAltUnit, sercomAltPad
	{ 0,  0,  0, -1, -1,  1,  0, -1}, // PIN 1
	{ 0,  1,  1, -1, -1,  1,  1, -1}, // PIN 2
	{ 0,  2,  2, -1, -1, -1, -1,  0}, // PIN 3
	{ 0,  3,  3, -1, -1, -1, -1,  1}, // PIN 4
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 5
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 6
	{ 1,  8,  8, -1, -1,  4,  0,  2}, // PIN 7
	{ 1,  9,  9, -1, -1,  4,  1,  3}, // PIN 8
	{ 0,  4,  4, -1, -1,  0,  0,  4}, // PIN 9
	{ 0,  5,  5, -1, -1,  0,  1,  5}, // PIN 10
	{ 0,  6,  6, -1, -1,  0,  2,  6}, // PIN 11
	{ 0,  7,  7, -1, -1,  0,  3,  7}, // PIN 12
	{ 0,  8, -1,  0,  0,  2,  0, 16}, // PIN 13
	{ 0,  9,  9,  0,  1,  2,  1, 17}, // PIN 14
	{ 0, 10, 10,  0,  2,  2,  2, 18}, // PIN 15
	{ 0, 11, 11,  0,  3,  2,  3, 19}, // PIN 16
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 17
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 18
	{ 1, 10, 10, -1, -1,  4,  2, -1}, // PIN 19
	{ 1, 11, 11, -1, -1,  4,  3, -1}, // PIN 20
	{ 0, 12, 12,  2,  0,  4,  0, -1}, // PIN 21
	{ 0, 13, 13,  2,  1,  4,  1, -1}, // PIN 22
	{ 0, 14, 14,  2,  2,  4,  2, -1}, // PIN 23
	{ 0, 15, 15,  2,  3,  4,  3, -1}, // PIN 24
	{ 0, 16,  0,  1,  0,  3,  0, -1}, // PIN 25
	{ 0, 17,  1,  1,  1,  3,  1, -1}, // PIN 26
	{ 0, 18,  2,  1,  2,  3,  2, -1}, // PIN 27
	{ 0, 19,  3,  1,  3,  3,  3, -1}, // PIN 28
	{ 0, 20,  4,  5,  2,  3,  2, -1}, // PIN 29
	{ 0, 21,  5,  5,  3,  3,  3, -1}, // PIN 30
	{ 0, 22,  6,  3,  0,  5,  0, -1}, // PIN 31
	{ 0, 23,  7,  3,  1,  5,  1, -1}, // PIN 32
	{ 0, 24, 12,  3,  2,  5,  2, -1}, // PIN 33
	{ 0, 25, 13,  3,  3,  5,  3, -1}, // PIN 34
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 35
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 36
	{ 1, 22,  6, -1, -1,  5,  2, -1}, // PIN 37
	{ 1, 23,  7, -1, -1,  5,  3, -1}, // PIN 38
	{ 0, 27, 15, -1, -1, -1, -1, -1}, // PIN 39
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 40
	{ 0, 28,  8, -1, -1, -1, -1, -1}, // PIN 41
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 42
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 43
	{-1, -1, -1, -1, -1, -1, -1, -1}, // PIN 44
	{ 0, 30, 10, -1, -1,  1,  2, -1}, // PIN 45
	{ 0, 31, 11, -1, -1,  1,  3, -1}, // PIN 46
	{ 1,  2,  2, -1, -1,  5,  0, 10}, // PIN 47
	{ 1,  3,  3, -1, -1,  5,  1, 11}, // PIN 48
...
#else // This is taking the spot for the SAMD21E18A, but also acting as a catch-all
...
// All default configs use SERCOM pad 0 for TX and SERCOM pad 3 for RX.
UARTPinConfig spi_default_defs[] =
{
	{ 11, 14}, //SERCOM 0
	{ 17, 20}, //SERCOM 1
	{ 29, 31}, //SERCOM 2
...
MorphPinNumber get_sercom_pad_pin_number(uint8_t sercom, bool alt, uint8_t pad_num)
{
	MorphPinNumber num_pins = sizeof(pin_defs)/sizeof(pin_defs[0]);
	for(MorphPinNumber i = 0; i < num_pins; i++)
	{
		if(!alt && pin_defs[i].sercomUnit == sercom && pin_defs[i].sercomPad == pad_num)
		{
			return i + 1;
		}
		else if(alt && pin_defs[i].sercomAltUnit == sercom && pin_defs[i].sercomAltPad == pad_num)
		{
			return i + 1;
		}
	}
...
void init_EIC()
{
	...
	for(uint8_t i = 0; i < EXT_INT_COUNT; i++)
	{
		pin_interrupt_functions[i] = &MorphUtils_empty_callback;
	}
	...
	GCLK->CLKCTRL.reg = GCLK_CLKCTRL_ID( 0x5 ) | // EIC ID is 0x5
...
void morph_config_gpio_set_pin_interrupt(void (*function)(void), MorphPinNumber pn, enum MorphExternalInterruptType it)
{
	
	static bool pin_int_en = false;
		if(!pin_int_en)
		{
			// Doing some initialization stuff for the interrupt.
			init_EIC();
		}

	
	// Okay, does this pin support EIC?
	int8_t ext_unit = pin_defs[pn - 1].extIntUnit;
	...
	// Before we get too carried away, set the callback function:
	pin_interrupt_functions[ext_unit] = function;
	
	// Get the EIC channel we'll be using.
	int8_t pin_group = pin_defs[pn - 1].pinGroup;
	int8_t pin_num = pin_defs[pn - 1].pinNumInGroup;
	
	// MUX into the interrupt ability.
	set_mux_group_config(EIC_PMUX, pin_group, pin_num);
	...
	// Let it wake from sleep.
	EIC->WAKEUP.reg |= 0x1 << ext_unit;

	// Are we on the top half, or the bottom half of the available ext units?
	EIC_CONFIG_Type * config_reg = NULL;
	uint8_t config_reg_pos = 0;
	
	if(ext_unit > 7)
	{
		config_reg = &EIC->CONFIG[1];
		config_reg_pos = (ext_unit - 8) << 2;
	}
	else
	{
		config_reg = &EIC->CONFIG[0];
		config_reg_pos = ext_unit << 2;		
	}	
	
	switch(it)
	{
		case NoInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_NONE_Val << config_reg_pos;
		break;
		case RisingEdgeInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_RISE_Val << config_reg_pos;
		break;
		case FallingEdgeInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_FALL_Val << config_reg_pos;
		break;
		case DualEdgeInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_BOTH_Val << config_reg_pos;
		break;
		case HighLevelInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_HIGH_Val << config_reg_pos;
		break;
		case LowLevelInterrupt:
			config_reg->reg |= EIC_CONFIG_SENSE0_LOW_Val << config_reg_pos;
		break;
	}
	EIC->INTENSET.reg |= 0x1 << ext_unit;
	__enable_irq();
...
void add_sercom_buff(uint8_t channel, uint16_t data)
{
	...
	{
		uart_buffer[channel][current_buffer_rear[channel]] = data;
...
void morph_config_uart_send_data(MorphUARTChannel c, MorphUARTData data)
{
	...
	// Now write the data!
	sercom_ptr->USART.DATA.reg = (uint16_t)data;
...
void morph_config_uart_send_byte(MorphUARTChannel c, MorphUARTByte byte)
{
	...
	// Now write the data!
	sercom_ptr->USART.DATA.reg = (uint16_t)byte;
}
...
bool morph_config_uart_data_ready(MorphUARTChannel c)
{
	...
	//
	//
	//return sercom_ptr->USART.INTFLAG.bit.RXC == 1;
...
typedef struct sercom_spi_rx_config{
	int8_t rx_pad_num;
} SercomSpiRxConfig ;

typedef struct sercom_spi_tx_config{
	int8_t tx_pad_num;
	int8_t sck_pad_num;
	int8_t ss_pad_num;
	uint8_t dopo_reg_val;	
} SercomSpiTxConfig ;

SercomSpiTxConfig spi_tx_defs[] =
{
	{ 0,  1,  2, 0x0},
	{ 2,  3,  1, 0x1},
	{ 3,  1,  2, 0x2},
...
void morph_config_spi_init_master(MorphI2CChannel c, MorphSPIBaudRate br, enum MorphSPIClockPhase cpha, enum MorphSPIClockPolarity cpol)
{
	...
	//Setting the Software bit to 1. This will do a software reset.
	sercom_ptr->SPI.CTRLA.bit.SWRST = 1;

	//Wait both bits Software Reset from CTRLA and SYNCBUSY are equal to 0
	while(sercom_ptr->SPI.CTRLA.bit.SWRST || sercom_ptr->SPI.SYNCBUSY.bit.SWRST);
	
	//Set SPI up for master mode.
	sercom_ptr->SPI.CTRLA.bit.MODE = 0x3; 

	// Set the polarity.
	sercom_ptr->SPI.CTRLA.bit.CPOL = cpol == MorphSPIClockPolarityStartIdle ? 0x0 : 0x1;

	// Set the phase.
	sercom_ptr->SPI.CTRLA.bit.CPHA = cpha == MorphSPIClockLowIdle ? 0x0 : 0x1;

	sercom_ptr->SPI.BAUD.bit.BAUD = SystemCoreClock / ( 2 * br) - 1;
	...
	while ( sercom_ptr->SPI.SYNCBUSY.bit.ENABLE != 0 );
...
void morph_config_spi_write(MorphSPIChannel c, MorphSPIByte b)
{
	...
	sercom_ptr->SPI.DATA.bit.DATA = b;	

	uint8_t count = 0;

	// Lets wait for it to send successfully. 
	while(sercom_ptr->SPI.INTFLAG.bit.RXC == 0 && (count < 0xFF)) count++;	
		
	rec_data[c] = sercom_ptr->SPI.DATA.bit.DATA;
		
}

void morph_config_spi_set_data_out_pin(MorphSPIChannel c, MorphPinNumber p_tx)
{
	// Determine if such a configuration is even possible.
	...
	if(pin_defs[p_tx - 1].sercomUnit == c)
	{
		uint8_t cur_sercom_pad = pin_defs[p_tx - 1].sercomPad;
		
		// This pin has the correct sercom unit on it!
		// Does this pin line-up with a correct pad?
		for(uint8_t i = 0; i < sizeof(spi_tx_defs) / sizeof(spi_tx_defs[0]); i++)
		{
			
			if(spi_tx_defs[i].tx_pad_num == cur_sercom_pad)
			{
				config_index = i;
				// This tx configuration works!
				// Configure to use this tx pin.
				do_config = true;
				use_config_alt = false;
				dopo_reg_val = spi_tx_defs[i].dopo_reg_val;
				break;
			}
			
		}
	}
	else if(pin_defs[p_tx - 1].sercomAltUnit == c)
	{
		uint8_t cur_sercom_pad = pin_defs[p_tx - 1].sercomAltPad;
	...
	if(do_config)
	{
		...
		bool was_enabled = sercom_ptr->SPI.CTRLA.bit.ENABLE == 1;
		
		if(was_enabled)
		{
			sercom_ptr->SPI.CTRLA.bit.ENABLE = 0;
		}
				
		// This configures the TX settings for the sercom unit.
		sercom_ptr->SPI.CTRLA.bit.DOPO = dopo_reg_val;
		...
		// TODO: Stop assuming we are the master. 
				
		MorphPinNumber sck_pin = get_sercom_pad_pin_number(c, use_config_alt, spi_tx_defs[config_index].sck_pad_num);
		
		int8_t sck_pin_group = pin_defs[sck_pin - 1].pinGroup;
		int8_t sck_pin_num   = pin_defs[sck_pin - 1].pinNumInGroup;
		
		if(use_config_alt)
			set_mux_group_config(SERCOM_ALT_PMUX, sck_pin_group, sck_pin_num);
		else
			set_mux_group_config(SERCOM_PMUX, sck_pin_group, sck_pin_num);
		
		// TODO: What to do about the ss pin?
		MorphPinNumber ss_pin = get_sercom_pad_pin_number(c, use_config_alt, spi_tx_defs[config_index].ss_pad_num);
		int8_t ss_pin_group = pin_defs[ss_pin - 1].pinGroup;
		int8_t ss_pin_num   = pin_defs[ss_pin - 1].pinNumInGroup;
		
		PORT->Group[ss_pin_group].PINCFG[ss_pin_num].bit.PMUXEN = 0;
		
		
		// The tx pin will always be an output. (obviously)
		morph_config_gpio_set_pin_direction(p_tx, Output);		

		// The sck pin is driven by the master.
		morph_config_gpio_set_pin_direction(sck_pin, Output);

		PORT->Group[sck_pin_group].PINCFG[sck_pin_num].bit.PMUXEN = 1;
		...
		// Save this config
		spi_current_defs[c].tx_pin_num = p_tx;
	}
...
void morph_config_spi_set_data_in_pin(MorphSPIChannel c, MorphPinNumber p_rx)
{
	...
	if(pin_defs[p_rx - 1].sercomUnit == c)
	{
		...
		// This configures the TX settings for the sercom unit.
		sercom_ptr->SPI.CTRLA.bit.DIPO = pin_defs[p_rx - 1].sercomPad;
		...
		// Save this config
		spi_current_defs[c].rx_pin_num = p_rx;
	...
	else if(pin_defs[p_rx - 1].sercomAltUnit == c)
	{
		...
		// This configures the TX settings for the sercom unit.
		sercom_ptr->SPI.CTRLA.bit.DIPO = pin_defs[p_rx - 1].sercomAltPad;
...
void morph_config_spi_set_sck_pin(MorphSPIChannel c, MorphPinNumber p_sck)
{
	...
	int8_t pin_group = pin_defs[p_sck - 1].pinGroup;
	int8_t pin_num   = pin_defs[p_sck - 1].pinNumInGroup;
	...
	// If TX has already been configured, we have to take it into account.
	MorphPinNumber tx_pin_num = spi_current_defs[c].tx_pin_num;

	int8_t cur_tx_pad = -1;
		
	if(tx_pin_num != -1 && pin_defs[tx_pin_num - 1].sercomUnit == c)
		cur_tx_pad = pin_defs[tx_pin_num - 1].sercomPad;
	else if(tx_pin_num != -1 && pin_defs[tx_pin_num - 1].sercomAltUnit == c)
		cur_tx_pad = pin_defs[tx_pin_num - 1].sercomAltPad;	
		
	if(pin_defs[p_sck - 1].sercomUnit == c)
	{
		uint8_t cur_sercom_pad = pin_defs[p_sck - 1].sercomPad;
		...
		for(uint8_t i = 0; i < sizeof(spi_tx_defs) / sizeof(spi_tx_defs[0]); i++)
		{
			...
			if((spi_tx_defs[i].sck_pad_num == cur_sercom_pad && tx_pin_num == -1) ||
			   (spi_tx_defs[i].sck_pad_num == cur_sercom_pad && cur_tx_pad == spi_tx_defs[i].tx_pad_num))
			{
				config_index = i;
				// This tx configuration works!
				do_config = true;
	...
	else if(pin_defs[p_sck - 1].sercomAltUnit == c)
	{
		uint8_t cur_sercom_pad = pin_defs[p_sck - 1].sercomAltPad;
	...
	if(do_config)
	{
		...
		// The tx pin will always be an output. (obviously)
		morph_config_gpio_set_pin_direction(p_sck, Output);
		...
		// Save this config
		spi_current_defs[c].sck_pin_num = p_sck;
	}
...
MorphADCValue morph_config_adc_get_maximum_value(MorphPinNumber p)
{
	...
	if(ADC->CTRLB.bit.RESSEL == 0x3)
	{
		// This is 8 bit.
		return ~(~(0x0UL) << 8);
	}
	else if(ADC->CTRLB.bit.RESSEL == 0x2)
	{
		// This is 10 bit.
		return ~(~(0x0UL) << 10);
	}
	else if(ADC->CTRLB.bit.RESSEL == 0x0)
	{
		// This is 12 bit.
		return ~(~(0x0UL) << 12);
	}
...
void morph_config_time_init_rtc()
{
	...
	SysTick->LOAD = 46920UL;			// This is a bit of a hack to make the ISR a bit more accurate.
