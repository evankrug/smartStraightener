...
void checkPlateStatus() 
{
	...
	if (currTemp < prevTemp && prevTemp > prevPrevTemp) //not getting to this point, likely due to duplicate temperature level readings; we'll need something more robust
	{
		trough = false;
		crest = true;
		tempDecreasing = false;
